...
export const MOCK_QUESTIONNAIRES: QuestionnaireData[] = [
  {
    ...
    qrToken: 'mock-token-q001-9f2a7c1e4b8d6a0f',
    qrIssuedAt: new Date().toISOString(),
    qrExpiresAt: new Date(Date.now() + 86400000).toISOString(),
    qrUsed: false,
    doctorClearance: '',
  ...
  },
  {
    ...
    qrToken: 'mock-token-q002-2e7a4c9b1d8f6a03',
    qrIssuedAt: new Date(Date.now() - 3600000).toISOString(),
    qrExpiresAt: new Date(Date.now() + 86400000).toISOString(),
    qrUsed: false,
    doctorClearance: '',
    staffCheckStatus: '未確認',
